  ...
  return (
    <><div className="pt-[24px] hero bg-base-200">
      <div className="hero-content flex-col lg:flex-row">
        ...
        <div>
          <h1 className="text-5xl font-bold flex items-center">{userData?.firstName + " " + userData?.lastName}</h1>
          <div className="divider"></div> 
          <div className="pb-2 flex items-center"><BsPersonCircle className='mr-[8px] text-[20px]' />{userData?.username}</div>
          <p className="py-2 flex items-center"><AiOutlineMail className='mr-[8px] text-[20px]'/>{userData?.email}</p>
