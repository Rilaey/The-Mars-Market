...
db.once('open', async () => {
    ...
    postSeeds[3].user = users[2]._id;
    postSeeds[4].user = users[0]._id;
    postSeeds[5].user = users[1]._id;
    postSeeds[6].user = users[2]._id;
    postSeeds[7].user = users[0]._id;
    postSeeds[8].user = users[1]._id;
